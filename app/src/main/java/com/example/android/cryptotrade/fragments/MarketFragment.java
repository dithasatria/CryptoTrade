                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            SaveData.PriceBTC = Integer.parseInt(resp.getTicker().getPriceLast());
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            TV_PERCENT_BTS.setText(decimal.format(hasilPercent) + "%");
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            Double lastPrice = Double.parseDouble(resp.getTicker().getPriceLast());
                            Double lowPrice = Double.parseDouble(resp.getTicker().getPriceLow());
                            String highPrice = resp.getTicker().getPriceHigh();
                            String vol_str = resp.getTicker().getVol_str();

                            SaveData.PriceSTR = resp.getTicker().getPriceLast();
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            String lastPrice = resp.getTicker().getPriceLast();
                            SaveData.PriceLTC = resp.getTicker().getPriceLast();

                            TV_PRICE_LTC.setText(lastPrice + " BTC");
                        }catch (Exception e){
                            e.printStackTrace();
                        }
                    }
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            String lastPrice = resp.getTicker().getPriceLast();
                            SaveData.PriceNXT = resp.getTicker().getPriceLast();

                            TV_PRICE_NXT.setText(lastPrice + " BTC");
                        }catch (Exception e){
                            e.printStackTrace();
                        }
                    }
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            String lastPrice = resp.getTicker().getPriceLast();
                            SaveData.PriceNEM = resp.getTicker().getPriceLast();

                            TV_PRICE_NEM.setText(lastPrice + " BTC");
                        }catch (Exception e){
                            e.printStackTrace();
                        }
                    }
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            String lastPrice = resp.getTicker().getPriceLast();
                            SaveData.PriceXRP = resp.getTicker().getPriceLast();

                            TV_PRICE_XRP.setText(lastPrice + " BTC");
                        }catch (Exception e){
                            e.printStackTrace();
                        }
                    }
